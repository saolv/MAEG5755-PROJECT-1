...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_poseStamped.pose.position.x =  0.7000;
    object_poseStamped.pose.position.y = -0.172;
     object_poseStamped.pose.position.z =  0.83;
    object_poseStamped.pose.orientation.x = 0;
    object_poseStamped.pose.orientation.y = 0;
    object_poseStamped.pose.orientation.z = 1.0;
